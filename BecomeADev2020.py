...
def find_median(arr):
    ...
    if arr_length % 2 == 0:
        ...
        median = int(arr_copy[arr_length // 2])
...
"""
Функции передается масив полученый ранее в create_list().
Возвращается количество последней наибольшей последовательности чисел, которые увеличиватся.
"""
...
"""
Функции передается масив полученый ранее в create_list().
Возвращается количество последней наибольшей последовательности чисел, которые уменьшаются.
"""
